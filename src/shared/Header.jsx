...
export const Header = () => {
    ...
    return (
        <div className='border-solid border-slate-200 border-b-2 fixed w-full bg-white z-50'>
            <header className='flex justify-between py-3 px-10 items-center'>
                ...
                <div className='action-icons'>
                    ...
                    <button onClick={() => navigate("../cart")} className='mx-2 relative'>
                        ...
                        <span class="bg-primary text-[12px] text-center absolute bottom-[-10px] right-[-10px] h-[20px] leading-[20px] rounded-[20px] px-[6px] transition-all group-hover:text-white">{products.length}</span>
                    </button>
